...
const alphaDataOperationsProvider_1 = require("./alphaDataOperationsProvider");
const upsertDocuments_1 = require("./upsertDocuments");
const searchDocuments_1 = require("./searchDocuments");
const fetchDocuments_1 = require("./fetchDocuments");
const deleteDocuments_1 = require("./deleteDocuments");
...
class PreviewIndex {
    ...
    constructor(config, options) {
        ...
        this._provider = new alphaDataOperationsProvider_1.AlphaDocumentOperationsProvider(config, options.name, options.host, options.additionalHeaders);
    }
    /**
     ...
     * @alpha
     */
    async upsertDocuments(namespace, options) {
        const api = await this._provider.provide();
        return (0, upsertDocuments_1.upsertPreviewDocuments)(api, namespace, options);
    }
    /**
     ...
     * @alpha
     */
    async searchDocuments(namespace, options) {
        const api = await this._provider.provide();
        return (0, searchDocuments_1.searchPreviewDocuments)(api, namespace, options);
    }
    /**
     ...
     * @alpha
     */
    async fetchDocuments(namespace, options) {
        const api = await this._provider.provide();
        return (0, fetchDocuments_1.fetchPreviewDocuments)(api, namespace, options);
    }
    /**
     ...
     * @alpha
     */
    async deleteDocuments(namespace, options) {
        const api = await this._provider.provide();
        return (0, deleteDocuments_1.deletePreviewDocuments)(api, namespace, options);
    }
}
exports.PreviewIndex = PreviewIndex;
//# sourceMappingURL=previewIndex.js.map