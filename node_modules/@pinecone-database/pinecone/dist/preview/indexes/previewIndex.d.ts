import { PreviewUpsertDocumentsOptions, PreviewUpsertDocumentsResponse } from './upsertDocuments';
import { PreviewSearchDocumentsOptions, PreviewSearchDocumentsResponse } from './searchDocuments';
import { PreviewFetchDocumentsOptions, PreviewFetchDocumentsResponse } from './fetchDocuments';
import { PreviewDeleteDocumentsOptions } from './deleteDocuments';
 ...
 * @alpha
 */
export declare class PreviewIndex {
    private _provider;
     ...
     * @alpha
     */
    upsertDocuments(namespace: string, options: PreviewUpsertDocumentsOptions): Promise<PreviewUpsertDocumentsResponse>;
    /**
     ...
     * @alpha
     */
    searchDocuments(namespace: string, options: PreviewSearchDocumentsOptions): Promise<PreviewSearchDocumentsResponse>;
    /**
     ...
     * @alpha
     */
    fetchDocuments(namespace: string, options: PreviewFetchDocumentsOptions): Promise<PreviewFetchDocumentsResponse>;
    /**
     ...
     * @alpha
     */
    deleteDocuments(namespace: string, options: PreviewDeleteDocumentsOptions): Promise<void>;
}
